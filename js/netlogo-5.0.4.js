 ...
 *			java -jar compiler.jar --compilation_level SIMPLE_OPTIMIZATIONS --js netlogo-5.0.4.js --js_output_file netlogo-5.0.4.min.js
	...
	function login_handler(event) {
		...
		if (msg_type === undefined) {
			...
			if (msg_type === "VersionMessage") {
				...
				nl_alert("login_handler: received unsupported message type: " + msg_type + ". This needs to be fixed in netlogo-x.x.x.js");
			}
		}
	}
